...
const Home = () => {
  return (
    <>
      <Header />
      <div 
        className="min-h-screen px-4 sm:px-8 py-12 max-w-7xl mx-auto relative"
        style={{
      ...
      >
        <div className="flex flex-col items-center justify-center space-y-8 sm:space-y-10 relative z-10">
