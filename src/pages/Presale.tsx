  ...
  return <>
      ...
      <div className="min-h-screen px-4 md:px-8 py-12 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-16 items-start">
          ...
          <div className="w-full md:w-1/2 space-y-6">
            <div className="p-2 neo-brutal-border bg-transparent flex justify-center items-center">
              <img src="/lovable-uploads/718d6294-9f6e-450a-a348-8e6978c36b54.png" alt="DAWG mascot" className="w-64 h-auto" />
            </div>
        ...
        <div className="neo-brutal-border bg-dawg/10 p-8 text-center">
          ...
          <Button onClick={handleApplyForPresale} className="py-6 px-8 text-lg neo-brutal-border bg-dawg hover:bg-dawg-secondary flex items-center justify-center gap-2 mx-auto">
